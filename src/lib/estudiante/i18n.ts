...
const DICCIONARIO: Record<Idioma, Record<string, string>> = {
  es: {
    ...
    perfil_sub: "Tu docente puede ver esta información.",
    perfil_foto: "Foto",
    ...
    perfil_pregunta_quien_soy: "¿Quién soy?",
    perfil_pregunta_proposito: "¿Cuál es mi propósito?",
    perfil_pregunta_recuerdo: "¿Cómo quiero ser recordado?",
    perfil_guardar: "Guardar",
    perfil_guardando: "Guardando...",
    perfil_guardado_exito: "Perfil guardado.",
  },
  en: {
    ...
    perfil_sub: "Your teacher can see this information.",
    perfil_foto: "Photo",
    ...
    perfil_pregunta_quien_soy: "Who am I?",
    perfil_pregunta_proposito: "What is my purpose?",
    perfil_pregunta_recuerdo: "How do I want to be remembered?",
    perfil_guardar: "Save",
    perfil_guardando: "Saving...",
    perfil_guardado_exito: "Profile saved.",
  },
  pt: {
    ...
    perfil_sub: "Seu professor pode ver esta informação.",
    perfil_foto: "Foto",
    ...
    perfil_pregunta_quien_soy: "Quem sou eu?",
    perfil_pregunta_proposito: "Qual é o meu propósito?",
    perfil_pregunta_recuerdo: "Como quero ser lembrado?",
    perfil_guardar: "Salvar",
    perfil_guardando: "Salvando...",
    perfil_guardado_exito: "Perfil salvo.",
  },
};
